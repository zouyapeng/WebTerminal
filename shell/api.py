...
from shell.serializers import ServerGroupSerializer,ServerInforSerializer,CommandsSequenceSerializer,CredentialSerializer
from shell.models import ServerGroup,ServerInfor,CommandsSequence,Credential
